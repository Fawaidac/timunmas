                ...
                <div class="col-12 col-xl-4">
                    <div class="justify-content-end d-flex">
                        <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                            <button class="btn btn-sm btn-light bg-white d-flex align-items-center gap-1">
                    ...
                    <div class="table-responsive mt-3">
                        <table class="table table-hover">
                            <tbody>
                                ...
                                <tr>
                                    <td><i class="icon-head text-primary mr-2"></i> Master Customer</td>
                                    <td class="text-right"><a href="{{ url('listcustomer') }}" class="btn btn-outline-primary btn-sm">Buka</a></td>
                                </tr>
                                <tr>
                                    <td><i class="icon-bag text-primary mr-2"></i> Order Penjualan</td>
                                    <td class="text-right"><a href="{{ url('listorder') }}" class="btn btn-outline-primary btn-sm">Buka</a></td>
                                </tr>
                                <tr>
                                    <td><i class="icon-check text-primary mr-2"></i> Approval Pembayaran</td>
                                    <td class="text-right"><a href="{{ route('admin.pembayaran.index') }}" class="btn btn-outline-primary btn-sm">Buka</a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
